...
# confidence_level = 90  
# print(f"The mean (\u03BC) estimate (\u03C3 unknown): {object.bound(90)}")
# print(f"The mean (\u03BC) estimate (\u03C3 known): {object.bound(90, sigma=11.28)}")
# print(f"The mean (\u03BC) estimate (No detail data): {object2.bound(90, sigma=11.28, mean=100, sample=15)}")
